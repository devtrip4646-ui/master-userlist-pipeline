  ...
  (async () => {
    ...
    document.getElementById('action-center-app').innerHTML = \`
      ...
      <section class="acc-orange">
        ...
        <div class="ac-note">Yesterday's first-time depositors only &middot; Bonus Utilised = placed at least one bet after the bonus was credited, same day &middot; New Users Lossback Amount's % is its share of Total Bonus &middot; Deposited After Lossback = of those who claimed New Users Lossback, made another completed deposit afterward, same day &middot; all other conversions are against 1st Deposit Users (Deposited After Lossback is against New Users Lossback Claimed)</div>
      </section>
      \` : ''}
    \`;
