  ...
  (async () => {
    ...
    document.getElementById('action-center-app').innerHTML = \`
      ...
      <section class="acc-orange">
        ...
        <div class="ac-note">VIP 2+ only &middot; Loss Rs 500-4,999 (80%+ of week's deposit lost): flat 1.5% &middot; Loss Rs 5,000-500,000: 50%-100%+ loss scales 2%-7% cashback (e.g. 65% loss = 3.2%) &middot; credited Sunday morning, no wagering requirement</div>
